...
const WEAPON_TRAITS = {
    ...
    'Disruptor': '+1d4 damage vs. synthetic enemies. Synthetic targets reduced to 0 Kinetic Barriers by this weapon are Stunned for 1 turn',
    'Electrical': '+1d6 damage vs. Kinetic Barriers and Biotic Barriers',
    'Heavy': 'Cannot move and shoot in same turn',
    'Marksman': '+3 to hit at all ranges when firing only 1 shot per turn. Bonus lost when using multiple shots',
    'Ramping Damage': 'Each consecutive hit on same target adds +1d4 damage (max +3d4 bonus). Resets when targeting different enemy, missing, or losing line of sight',
    'Rapid Fire': 'All classes can fire multiple times per turn. Second and subsequent attacks at -2 to hit (stacks). Soldiers reduce penalty to -1 per additional shot',
    'Reliable': 'Reroll one failed attack roll per mission',
    'Ricochet': 'Can attack targets without direct line of sight by bouncing shots off surfaces. Ignores cover Evasion bonuses when using ricochet shots',
    'Self-Cooling': 'This weapon requires no thermal clips for missions',
    // Legacy traits for non-assault rifles
...
const WEAPON_DATA = {
    ...
    'M-15 Vindicator': { range: '15 hexes', damage: '2d4 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Burst Fire, Accurate' },
    'M-96 Mattock': { range: '16 hexes', damage: '1d8 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Marksman, Devastating' },
    'M-37 Falcon': { range: '12 hexes', damage: '1d8 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Heavy, Devastating' },
    'M-76 Revenant': { range: '14 hexes', damage: '1d6 + Combat', type: 'Kinetic', shots: '2 (+1 Rapid Fire) (Soldier: 3 +1)', traits: 'Heavy, Rapid Fire' },
    'M-55 Argus': { range: '12 hexes', damage: '2d6 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Burst Fire' },
    'M-99 Saber': { range: '18 hexes', damage: '2d6 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Marksman' },
    'Geth Pulse Rifle': { range: '16 hexes', damage: '2d4 + Combat', type: 'Electrical', shots: '1 (+1 Rapid Fire) (Soldier: 2 +1)', traits: 'Accurate, Electrical, Rapid Fire' },
    'Adas Anti-Synthetic Rifle': { range: '14 hexes', damage: '1d6 + Combat', type: 'Electrical', shots: '2 (Soldier: 3)', traits: 'Electrical, Disruptor, Reliable' },
    'Chakram Launcher': { range: '12 hexes', damage: '1d8 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Ricochet' },
    'Phaeston': { range: '14 hexes', damage: '1d6 + Combat', type: 'Kinetic', shots: '2 (+1 Rapid Fire) (Soldier: 3 +1)', traits: 'Rapid Fire, Reliable' },
    'Collector Assault Rifle': { range: '14 hexes', damage: '1d6 + Combat', type: 'Kinetic', shots: '2 (+1 Rapid Fire) (Soldier: 3 +1)', traits: 'Rapid Fire, Accurate' },
    'N7 Valkyrie': { range: '14 hexes', damage: '2d4 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Burst Fire, Reliable, Accurate' },
    'Particle Rifle': { range: '12 hexes', damage: '1d4 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'Ramping Damage, Self-Cooling, Accurate' },
    'Cerberus Harrier': { range: '14 hexes', damage: '1d10 + Combat', type: 'Kinetic', shots: '1 (+1 Rapid Fire) (Soldier: 2 +1)', traits: 'Devastating, Rapid Fire' },
    'N7 Typhoon': { range: '14 hexes', damage: '1d6 + Combat', type: 'Kinetic', shots: '2 (+1 Rapid Fire) (Soldier: 3 +1)', traits: 'Heavy, Rapid Fire' },

    // Shotguns
    'M-23 Katana': { range: '6 hexes', damage: '1d8 + Combat', type: 'Kinetic', shots: '1 (Soldier: 2)', traits: 'None' },
    ...
    infoElement.innerHTML = `
        <div class="power-details">
            <div class="power-header">
                ...
                ${currentUpgrade ? `<span class="power-upgrade-indicator">[${currentUpgrade}]</span>` : ''}
            </div>
            <div class="power-stats">
                ...
                <div class="stat-row">
                    ...
                    <strong>Targeting:</strong> ${powerStats.targeting}
                </div>
                <div class="stat-row">
            ...
            <div class="power-description">
                <strong>Details:</strong> ${powerStats.details}
            </div>
            ${upgradeInfo}
            <div class="power-special">
                <strong>Special Rules:</strong> ${powerStats.special}
            </div>
        </div>
    `;
}
...
function getPowerStats(power, level, upgrade) {
    ...
    let stats = {
        cost: power.cost,
        range: power.range,
        targeting: power.targeting || 'Not specified',
        xpCost: power.xpCost,
